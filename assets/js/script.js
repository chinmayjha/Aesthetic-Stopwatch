...
// ================================================================================================
// OFFLINE/ONLINE DETECTION AND PWA ENHANCEMENTS
// ================================================================================================
(function initializeOfflineDetection() {
  ...
  if (!navigator.onLine) {
    setTimeout(showOfflineStatus, 1000);
  }
...
(function enhanceInstallPrompt() {
  ...
  function showIOSInstallPrompt() {
    ...
    if (isIOS && !isInStandaloneMode) {
      // Could show a custom modal with iOS install instructions
...
(function monitorPerformance() {
  ...
  try {
    // Monitor page visibility for better timer accuracy
    document.addEventListener('visibilitychange', () => {
      if (document.hidden) {
        console.log('Page hidden - pause unnecessary operations');
      } else {
        console.log('Page visible - resume operations');
        // Resync stopwatch if running
...
(function enhanceKeyboardShortcuts() {
  ...
  // Add keyboard shortcut indicator (could be shown in a help modal)
...
(function enhanceAccessibility() {
  // Announce stopwatch state changes to screen readers
...
(function enhanceThemeHandling() {
  ...
  if (window.matchMedia) {
    ...
    darkModeQuery.addEventListener('change', (e) => {
      ...
      if (!savedTheme || JSON.parse(savedTheme) === 'auto') {
        // Update theme if set to auto
...
console.log('🎯 Aesthetic Stopwatch loaded successfully!');
